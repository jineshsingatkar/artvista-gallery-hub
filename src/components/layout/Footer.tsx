      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-artvista-primary">ArtVista</h3>
            <p className="text-sm text-muted-foreground">
              Connecting art lovers with talented artists through a curated marketplace of unique artworks.
            </p>
          </div>
          ...
          <div>
            <h4 className="font-semibold text-base mb-4">For Artists</h4>
            <ul className="space-y-2">
              <li>
                <Link to="/signup?role=artist" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Join as Artist
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>Email: info@artvista.com</li>
              <li>Phone: +1 (555) 123-4567</li>
              <li>Address: 123 Art Avenue, Creative District, CA 90210</li>
            </ul>
